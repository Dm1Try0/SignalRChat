...
namespace Chat.AuthService.Web.HostedServices
{
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            if (await manager.FindByClientIdAsync(client_id1, cancellationToken) is null)
            {
                await manager.CreateAsync(new OpenIddictApplicationDescriptor
                {
                    ...
                    DisplayName = "Service-To-Service demonstration", //"Service-To-Service demonstration"
                    Permissions =
                    {
              ...
              //  OpenIddictConstants.Permissions.Prefixes.GrantType + "Chat.ConsoleApplication"
                    }
                }, cancellationToken);
            }
